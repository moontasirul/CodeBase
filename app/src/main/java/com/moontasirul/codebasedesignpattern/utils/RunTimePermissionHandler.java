...
public class RunTimePermissionHandler {
     ...
     * Location permission array
     */
    private static String[] permissionsArray = new String[]{READ_PHONE_STATE,
    ...
    public static boolean requestReadPhoneState(FragmentActivity activity) {
        ...
        if (ContextCompat.checkSelfPermission(activity, READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED) {
            ...
            activity.requestPermissions(new String[]{READ_PHONE_STATE}, Constant.REQUEST_READ_PHONE_STATE);
        }
        return false;
    }
